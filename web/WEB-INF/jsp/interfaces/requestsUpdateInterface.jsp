        ...
        <form method="post">
            ...
            <table border="0" width="85%" align="center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="25%" >Scientists name:</td>
                        <td width="25%"><spring:bind path="command.sci_firstname">
                                <c:out value="${status.value}"/>
                            </spring:bind>&nbsp;<spring:bind path="command.sci_surname">
                                <c:out value="${status.value}"/></spring:bind>
                            <td width="25%">Requested material:</td>
                            <td width="25%"><spring:bind path="command.req_material">
                                <c:out value="${status.value}"/>
                    ...
                    <tr>
                        <td align="center" class="nowrap">MTA Arrived Date:<br/>
                            <spring:bind path="command.mta_arrived_date"><input type="text"  size="11" name="<c:out value='${status.expression}'/>"   id="<c:out value='${status.expression}'/>" value="<c:out value='${fn:substringBefore(status.value, " ")}'/>" ${show} > <img src="../images/cal.gif"  id="MTAArrivedDate" border="0"/>
                                <script type="text/javascript">
                                    Calendar.setup(
                                    {
                            ...
                            <td align="center" width="25%" class="nowrap">Payment (information) in place date:<br/>
                            <spring:bind path="command.payment_date"><input type="text"  size="11" name="<c:out value='${status.expression}'/>"   id="<c:out value='${status.expression}'/>" value="<c:out value='${fn:substringBefore(status.value, " ")}'/>" ${show} > <img src="../images/cal.gif"  id="PaymentDate" border="0"/>
                                <script type="text/javascript">
                                    Calendar.setup(
                                    {
                                        inputField  : "<c:out value='${status.expression}'></c:out>",
                            ...
                            <td align="center" width="25%" class="nowrap">Import permission arrived date:<br/>
                            <spring:bind path="command.import_permission_date"><input type="text"  size="11" name="<c:out value='${status.expression}'/>"   id="<c:out value='${status.expression}'/>" value="<c:out value='${fn:substringBefore(status.value, " ")}'/>" ${show} > <img src="../images/cal.gif"  id="ImportPermissionDate" border="0"/>
                                <script type="text/javascript">
                                    Calendar.setup(
                                    {
                                        inputField  : "<c:out value='${status.expression}'></c:out>",
                                        ifFormat    : "%Y-%m-%d",
                                        button      : "ImportPermissionDate"     
                                    }
                                );
                                    </script></spring:bind> </td>

                            <td align="center" width="25%" class="nowrap">Processed Date:<br/>
                            <spring:bind path="command.date_processed">
                                <input type="text" id="<c:out value="${status.expression}"/>" name="<c:out value="${status.expression}"/>" size="11" value="<c:out value="${status.value}"/>">
