...
<html>
    ...
    <body>
        ...
        <p><center><input type="button" alt="Insert a new request using this interface" value="Insert Request" onclick="javascript:window.parent.location='${sessionScope.BASEURL}emma/RegisterInterest/requestFormView.emma?new=y&status=insert&user=<c:out value="${fn:toUpperCase(UserName)}" />'"/></center></p>
        <p>&nbsp;</p>
