...
<html>
    ...
    <body>
        ...
        <c:if test="${keyRef['searchSize'] != 0}">
            <%-- DATAGRID BEGINS --%>
            <table class="datagrid" align="center" style="text-align: left; width: 80%;" border="1"
                    ...
                    <c:forEach var="str" items='${keyRef["results"]}' varStatus="row">
                        <tr class="<c:choose>
                            ...
                            <td align="center" valign="top">
                                ...
                                <c:if test="${UserName ne 'super'}"><c:set var="PObuttonStatus" value='class="disabled" disabled'></c:set></c:if>
                            <input ${PObuttonStatus} type="button" value="Edit PO" name="${str[8]}" onClick="parent.location='poUpdateInterface.emma?poEdit=${str[8]}&id=${str[9]}'" /></td>
