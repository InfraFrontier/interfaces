...
<head>
    ...
    <meta content="text/html; charset=UTF-8" http-equiv="content-type"><title>EMMA interest registration and strain requests</title>
        ...
        <tbody>
            <tr>
                <td>Dear Scientist<br>
                    ...
                    <c:if test="${command.register_interest == '1' && command.id_req == null}" > 
                        will receive automated notice as soon as the strain becomes available.
                    </c:if> 
                    <c:if test="${command.id_req != null}" >
                ...
                <td class="noborder">
                    <spring:bind path="command.con_country">
                        <select name="con_country">
                            ...
                            <c:choose>
                                <c:when test="${command.con_country  == 'Brasil'}" >
                            ...
                            <c:choose>
                                <c:when test="${command.con_country  == 'United Kingdom'}" >
                            ...
                            <c:choose>
                                <c:when test="${command.con_country  == 'United States'}" >
...
<c:choose>
    <c:when test="${command.id_req} != null" >
        <b>Material you have requested:</b>
    </c:when>
    <c:otherwise> 
        <b>Material you intend to request:</b><br />
